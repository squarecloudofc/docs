...
First you need to get an API key from the [Developer Dashboard](https://squarecloud.app/dashboard/settings). You can use this API key to authenticate to the Square Cloud API.
