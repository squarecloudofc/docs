...
description: "This documentation provides a comprehensive overview of the GET /v1/list endpoint of the SquareCloud Blob API."
api: "GET https://blob.squarecloud.app/v1/list"
authMethod: "none"
---
...
<ResponseField name="expire_at" type="ISO 8601">
...
```json Response - [30s cache]
{
  ...
  "response": {
    "objects": [
      {
        "name": "ID/prefix/name1_ltq7b2sw-de6241.jpeg",
        "size": 78266,
        "created_at": "2024-03-13T19:31:28.776Z"
      },
      {
        "name": "ID/prefix/name_ltq7b2sw-de6243-ex1.jpeg",
        "size": 90466,
        "created_at": "2024-03-13T19:35:28.776Z",
        "expire_at": "2024-03-14T19:35:28.776Z"
      },
    ]
  }
}
