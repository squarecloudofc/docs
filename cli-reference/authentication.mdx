...
<Steps>
    <Step title="Get API key">
        First you need to get an API key from the [Developer Dashboard](https://squarecloud.app/account/security). You can use this API key to authenticate to the Square Cloud CLI.
    </Step>
