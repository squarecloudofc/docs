...
_This implementation was inspired by a [suggestion](https://github.com/squarecloudofc/wrapper-api-py/pull/1) made by [@Mudinho](https://github.com/zRickz), thank you for contributing._