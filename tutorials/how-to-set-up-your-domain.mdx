...
- Finally, point your domain to "cname.squarecloud.app" with the type "CNAME", replacing "name" with your domain, and another with the type TXT with the value that will appear in "DNS Configuration" after clicking "save".
<Frame>
