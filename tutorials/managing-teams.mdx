...
<Steps>
  <Step title="First Step" icon="check">
    Ask the user you want to add to access the [config](https://squarecloud.app/dashboard/settings) page and trigger the `request team code` button. They should then send you the generated account code. Remember that this code can only be used once and expires after **5 minutes**.
  </Step>
