...
Before you start, it's necessary that you have a plan higher than Hobby. Starting from the Standard plan, you can already create a team (with only 1 member). To upgrade your current plan, you can visit our plans [page](https://squarecloud.app/plans)
...
<Steps>
  ...
  <Step title="Third Step" icon="envelope">
    Click on your profile and select the team to which you want to add the user, then click on the “Invite member” button.  
  </Step>
