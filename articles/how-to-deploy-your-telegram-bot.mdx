...
Before you start coding, you need to properly set up your bot on Telegram:
...
<AccordionGroup>
  <Accordion title="Getting Started" icon="rocket" iconType="solid">
    ...
    <Frame>
      <img src="https://i.imgur.com/s7wIwTD.png" style={{ borderRadius: "0.2rem" }} />
    </Frame>
  </Accordion>
  ...
  <Accordion title="Getting the Token" icon="key" iconType="solid">
    ...
    <Frame>
      <img src="https://i.imgur.com/RjBSyHo.png" style={{ borderRadius: "0.2rem" }} />
    </Frame>
  </Accordion>
</AccordionGroup>

## Creating a New Telegram Bot with Python (telebot)
...
If you have done everything correctly, simply search for your bot on Telegram and send a message; it will echo it back to you.
    ...
    <Frame>
      <img src="https://i.imgur.com/wne3VDh.png" style={{ borderRadius: "0.2rem" }} />
    </Frame>
