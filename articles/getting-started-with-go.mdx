...
## Introduction
This tutorial will have you deploying a Go app to Square Cloud in minutes.

The tutorial assumes that you have a [Square Cloud account](https://squarecloud.app/login), and that you have [Go](https://go.dev/doc/install) installed locally.
