...
sidebarTitle: "Create your config file"
...
<Note>Minimum **memory** for **bot** is **100mb** (**256MB MINIMUM RECOMMENDED**) and for **website 512mb**</Note>

| Required parameters | Description                           | Example                               |
| ------------------- | ------------------------------------- | ------------------------------------- |
| MAIN                | Main file of your application         | MAIN=index.js                         |
| MEMORY              | Amount of memory ram                  | MEMORY=256                            |
