...
The tutorial assumes that you have a [Square Cloud account](https://squarecloud.app/login), and that you have [Rust](https://www.rust-lang.org/pt-BR/tools/install) installed locally.
