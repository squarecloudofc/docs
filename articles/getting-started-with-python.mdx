...
The tutorial assumes that you have a [Square Cloud account](https://squarecloud.app/login), and that you have [Python](https://www.python.org/downloads/) installed locally.
