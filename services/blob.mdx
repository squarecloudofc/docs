...
| Text        | .html, .css, .csv                                                            |
| Application | .xml, .sqlite3, .pdf, .json, .javascript                                     |
...
<Steps>
  ...
  title="Initial Setup" icon="file">
    The first step to host your asset on **Square Cloud** is to upload your file into the [put endpoint](/api-reference/endpoint/blob/put). This endpoint allows you to upload your file to the serverless storage.    
  </Step>
  <Step 
