...
First you need to get an API key from the [Developer Dashboard](https://squarecloud.app/dashboard/account). You can use this API key to authenticate to the Square Cloud API.
