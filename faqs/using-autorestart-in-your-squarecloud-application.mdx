...
<Note>Auto Restart is a **PAID feature**, so you need to [**buy a plan**](https://squarecloud.app/plans) that supports it.</Note>
To take advantage of Auto Restart, you must have a Square Cloud paid plan.
